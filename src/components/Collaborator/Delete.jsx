...
const Delete = () => {
    const { isDeleteCollaborator, handleDeleteCollaborator, deleteCollaborator, collaborator } = useProjects()

    return (
        <Transition.Root show={isDeleteCollaborator} as={Fragment} onClose={() => handleDeleteCollaborator({})}>
